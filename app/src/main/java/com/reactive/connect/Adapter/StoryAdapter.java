...
import com.reactive.connect.Activities.AddStoryActivity;
import com.reactive.connect.Activities.StoryActivity;
...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder>{
    ...
    private void userInfo(final ViewHolder viewHolder, String userid, final int pos){
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference(Constants.USERS).child(userid);
...
//                }
                ...
                if (pos != 0) {
                    ...
                    viewHolder.story_username.setText(user.getImage());
                }
            }
