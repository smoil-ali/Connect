...
public class InterestFragment extends Fragment implements InterestListener {

    final String TAG = InterestFragment.class.getSimpleName();
    List<String> list = new ArrayList<>();
    List<String> interestList = new ArrayList<>();
    InterestFragmentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.interest_fragment,container,false);
        ...
        adapter = new InterestAdapter(getContext(),interestClasses);
